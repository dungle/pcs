...
namespace PCSComSale.Order.DS
{
	...
	public class SO_CancelReasonDS 
	{
		public SO_CancelReasonDS()
		{
		}
		private const string THIS = "PCSComSale.Order.DS.SO_CancelReasonDS";
		...
		//**************************************************************************              
		///    <Description>
		///       This method uses to delete data from SO_CancelReason
		///    </Description>
		///    <Inputs>
		///        ID       
		///    </Inputs>
		...
		public void Delete(int pintID)
		{
			...
			string strSql = String.Empty;
			strSql=	"DELETE " + SO_CancelReasonTable.TABLE_NAME + " WHERE  " + "CancelReasonID" + "=" + pintID.ToString();
			OleDbConnection oconPCS=null;
			OleDbCommand ocmdPCS =null;
			try
			{
		...
		//**************************************************************************              
		///    <Description>
		///       This method uses to get all data from SO_CancelReason
		///    </Description>
		///    <Inputs>
		///               
		///    </Inputs>
		...
		public DataSet List()
		{
			...
			try 
			{
				...
				odadPCS.Fill(dstPCS,SO_CancelReasonTable.TABLE_NAME);
		...
		+ "  FROM " + SO_CancelReasonTable.TABLE_NAME;
				...
				odadPCS.Update(pData,SO_CancelReasonTable.TABLE_NAME);
