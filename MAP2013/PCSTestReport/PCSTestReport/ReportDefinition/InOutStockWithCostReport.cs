...
namespace InOutStockWithCostReport
{
	[Serializable]
	public class InOutStockWithCostReport : MarshalByRefObject, IDynamicReport
	{
		public InOutStockWithCostReport()
		{
		}
		...
		{			
			const string REPORT_TEMPLATE = "InOutStockWithCostReport.xml";
			const string RPT_PAGE_HEADER = "PageHeader";

			const string REPORT_NAME = "InOutStockWithCostReport";
